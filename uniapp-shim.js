            ...
            (function() {
              ...
              var CustomCollect = window.Vue.defineComponent({
                ...
                template: [
                  ...
                  '      <input class="cc-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.sales || 0" @input="updateField(\'sales\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">系统库存——裸养（支）</label>',
                  '      <input class="cc-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.looseActual || 0" @input="updateField(\'looseActual\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">实际盘点库存——裸养（支）</label>',
                  '      <input class="cc-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.looseCounted || 0" @input="updateField(\'looseCounted\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">系统库存——盒</label>',
                  '      <input class="cc-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.boxedActual || 0" @input="updateField(\'boxedActual\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">实际盘点库存——盒</label>',
                  '      <input class="cc-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.boxedCounted || 0" @input="updateField(\'boxedCounted\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell" v-if="collectRatio">',
                  '      <label class="cc-input-label">单支 : 盒销 : 自吸</label>',
                  '      <div class="cc-ratio-row">',
                  '        <input class="cc-ratio-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.diao || 0" @input="updateField(\'diao\', $event.target.value)" />',
                  '        <span class="cc-ratio-sep">:</span>',
                  '        <input class="cc-ratio-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.hexiao || 0" @input="updateField(\'hexiao\', $event.target.value)" />',
                  '        <span class="cc-ratio-sep">:</span>',
                  '        <input class="cc-ratio-input" type="number" inputmode="decimal" step="0.1" :value="formForCurrent.zixi || 0" @input="updateField(\'zixi\', $event.target.value)" />',
                  '      </div>',
