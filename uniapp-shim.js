            ...
            (function() {
              ...
              var CustomCollect = window.Vue.defineComponent({
                ...
                template: [
                  ...
                  '      <input class="cc-input" type="number" inputmode="numeric" :value="formForCurrent.sales || 0" @input="updateField(\'sales\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">系统库存——裸养（支）</label>',
                  '      <input class="cc-input" type="number" inputmode="numeric" :value="formForCurrent.looseActual || 0" @input="updateField(\'looseActual\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">实际盘点库存——裸养（支）</label>',
                  '      <input class="cc-input" type="number" inputmode="numeric" :value="formForCurrent.looseCounted || 0" @input="updateField(\'looseCounted\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">系统库存——盒</label>',
                  '      <input class="cc-input" type="number" inputmode="numeric" :value="formForCurrent.boxedActual || 0" @input="updateField(\'boxedActual\', $event.target.value)" />',
                  '    </div>',
                  '    <div class="cc-input-cell">',
                  '      <label class="cc-input-label">实际盘点库存——盒</label>',
                  '      <input class="cc-input" type="number" inputmode="numeric" :value="formForCurrent.boxedCounted || 0" @input="updateField(\'boxedCounted\', $event.target.value)" />',
                  '    </div>',
